...
const deleteProducts = async() => {
    url = 'https://nodejs-production-0e08.up.railway.app/product';
    ...
    for (let product of products) {
        const response = await axios.delete(`https://nodejs-production-0e08.up.railway.app/product/${product.id}`)
